      ...
      >
        ...
        >
          ...
          <div className="relative z-[1] flex flex-col gap-2">
            ...
            <input id="contact-name" name="name" type="text" autoComplete="name" placeholder="Enter your name" className="h-[46px] rounded-[0.85rem] border border-black/15 bg-white/80 px-[0.9rem] text-[0.95rem] text-black/90 shadow-[inset_0_1px_0_rgba(255,255,255,0.6),0_10px_22px_rgba(0,0,0,0.06)] transition-[border-color,box-shadow,background-color,transform] duration-150 placeholder:text-black/45 focus:-translate-y-[1px] focus:border-[#BDFF00]/70 focus:bg-white/90 focus:outline-none focus:shadow-[0_0_0_3px_rgba(189,255,0,0.18),0_18px_40px_rgba(0,0,0,0.10)]" />
          </div>
          ...
          <div className="relative z-[1] flex flex-col gap-2">
            ...
            <input id="contact-email" name="email" type="email" autoComplete="email" placeholder="name@example.com" className="h-[46px] rounded-[0.85rem] border border-black/15 bg-white/80 px-[0.9rem] text-[0.95rem] text-black/90 shadow-[inset_0_1px_0_rgba(255,255,255,0.6),0_10px_22px_rgba(0,0,0,0.06)] transition-[border-color,box-shadow,background-color,transform] duration-150 placeholder:text-black/45 focus:-translate-y-[1px] focus:border-[#BDFF00]/70 focus:bg-white/90 focus:outline-none focus:shadow-[0_0_0_3px_rgba(189,255,0,0.18),0_18px_40px_rgba(0,0,0,0.10)]" />
          </div>
          ...
          <div className="relative z-[1] flex flex-col gap-2">
            ...
            <input id="contact-subject" name="subject" type="text" placeholder="What would you like to talk about?" className="h-[46px] rounded-[0.85rem] border border-black/15 bg-white/80 px-[0.9rem] text-[0.95rem] text-black/90 shadow-[inset_0_1px_0_rgba(255,255,255,0.6),0_10px_22px_rgba(0,0,0,0.06)] transition-[border-color,box-shadow,background-color,transform] duration-150 placeholder:text-black/45 focus:-translate-y-[1px] focus:border-[#BDFF00]/70 focus:bg-white/90 focus:outline-none focus:shadow-[0_0_0_3px_rgba(189,255,0,0.18),0_18px_40px_rgba(0,0,0,0.10)]" />
          </div>
